...
function [delay_calc] = Localization2(distance,angle,sen1,sen2)
    angle = angle*(pi/180);
    ...
    delay1 = sqrt((x-sen1(1))^2+(y-sen1(2))^2)/v; % sensor 1
    delay2 = sqrt((x-sen2(1))^2+(y-sen2(2))^2)/v; % sensor 2
    ...
    %predicted_angle = acos(delay_calc*v/3)*(180/pi);
end